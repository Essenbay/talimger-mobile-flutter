...
import 'package:talimger_mobile/constants/app_constants.dart';
import 'package:talimger_mobile/screens/notifications/custom_notification_details.dart';
import 'package:talimger_mobile/services/hive_service.dart';
import 'package:talimger_mobile/services/sp_service.dart';
import 'package:talimger_mobile/utils/next_screen.dart';
import 'package:talimger_mobile/screens/notifications/notification_dialog.dart';
...
class NotificationService {
  ...
  Future initFirebasePushNotification(
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      await HiveService()
          ...
          .then((value) => _openNotificationDialog(context, message));
    });
