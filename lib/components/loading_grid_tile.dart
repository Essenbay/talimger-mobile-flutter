    ...
    return GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return Shimmer.fromColors(
          baseColor: AppService.isDarkMode(context)
              ? CustomColor.shimmerBaseColorDark
              : CustomColor.shimmerBaseColor,
          highlightColor: AppService.isDarkMode(context)
              ? CustomColor.shimmerhighlightColorDark
              : CustomColor.shimmerHighlightColor,
          child: Container(
            color: Colors.white,
          ),
        );
