...
import 'package:talimger_mobile/utils/string_extension.dart';
...
class CustomNotificationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      onTap: () async {
        ...
        NextScreen.openBottomSheet(context,
  ...
  static String _getDate(
    ...
    final String date =
        DateFormat('MMMM dd, yyyy').format(notificationModel.recievedAt);
    return date;
  }
}
