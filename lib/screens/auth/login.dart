...
import 'package:talimger_mobile/screens/auth/reset_password.dart';
import 'package:talimger_mobile/screens/auth/sign_up.dart';
...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future _handleLoginWithUsernamePassword() async {
    if (formKey.currentState!.validate()) {
      ...
      final UserCredential? user = await AuthService().loginWithEmailPassword(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () =>
                          NextScreen.iOS(context, const ResetPassword()),
                    ),
                  ),
