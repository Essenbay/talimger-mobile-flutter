...
import 'package:talimger_mobile/screens/course_details.dart/review_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          : reviews.isEmpty
              ? EmptyAnimation(
                  animationString: emptyAnimation, title: 'no-review'.tr())
              : RefreshIndicator(
