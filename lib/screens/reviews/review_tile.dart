  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          border: Border.all(
              color: isDarkMode ? CustomColor.borderDark : CustomColor.border),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              UserAvatar(
                  imageUrl: review.reviewUser.imageUrl,
                  radius: 20,
                  iconSize: 12),
          ...
          Text(
            AppService.getDateTime(review.createdAt, locale: context.locale),
            style: Theme.of(context)
                .textTheme
                .bodyMedium
        ...
        return [
          PopupMenuItem(
            ...
            onTap: () {
              ...
              final supportEmail =
                  ref.read(appSettingsProvider)?.supportEmail ?? '';
              AppService()
                  .openReviewReportEmail(context, review, user, supportEmail);
            },
          ),
        ];
      },
