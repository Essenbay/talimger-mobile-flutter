...
import 'package:talimger_mobile/models/question.dart';
import 'package:talimger_mobile/screens/quiz_lesson/question_tile.dart';
import 'package:talimger_mobile/screens/quiz_lesson/quiz_complete.dart';
...
final questionPageControllerProvider =
    ...
    return Scaffold(
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: TextButton(
            ...
            onPressed: () => _onNextBtnPressed(context, selectedOption,
                currentPageIndex, questions, ref, pageController),
            child: Text('next',
    ...
    if (selectedOption != null) {
      if ((currentPageIndex + 1) >= questions.length) {
        NextScreen.replaceAnimation(context,
            QuizComplete(course: widget.course, lesson: widget.lesson));
      } else {
