...
import 'package:talimger_mobile/components/mark_complete_button.dart';
...
class QuizComplete extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final double percentage =
        (correctAnswerCount / lesson.questions!.length) * 100;
          ...
          : BottomAppBar(
              ...
              child: TextButton(
                ...
                onPressed: () {
                  ...
                  NextScreen.replaceAnimation(
                      context, QuizLesson(course: course, lesson: lesson));
                },
              ),
            ),
      body: Center(
