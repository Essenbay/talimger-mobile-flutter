...
import 'package:talimger_mobile/components/author_card.dart';
import 'package:talimger_mobile/components/loading_tile.dart';
import 'package:talimger_mobile/models/user_model.dart';
import 'package:talimger_mobile/screens/all_authors.dart';
...
final topAuthorsProvider = FutureProvider<List<UserModel>>((ref) async {
  final List<UserModel> authors =
      await FirebaseService().getTopAuthors(limit: 5);
  return authors;
});
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: () =>
                              NextScreen.normal(context, const AllAuthors()),
