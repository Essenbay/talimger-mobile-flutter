...
import 'package:talimger_mobile/components/horizontal_course_tile.dart';
...
final category2CoursessProvider =
    FutureProvider.family<List<Course>, String>((ref, categoryId) async {
  final List<Course> courses =
      await FirebaseService().getHomeCategoryCourses(categoryId, 5);
  return courses;
});
