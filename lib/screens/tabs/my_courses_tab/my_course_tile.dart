...
import 'package:talimger_mobile/components/price_tag.dart';
...
class MyCourseTile extends StatelessWidget with UserMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final double courseProgress = validIds.isEmpty
        ? 0
        : (validIds.length /
            (course.lessonsCount != 0 ? course.lessonsCount : 1));
              ...
              Container(
                ...
                child: Hero(
                    ...
                    child: CustomCacheImage(
                        imageUrl: course.thumbnailUrl, radius: 3)),
              ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('percent-completed')
                      .tr(args: [courseProgesString]),
                  const SizedBox(
                    height: 10,
                  ),
                  OutlinedButton(
                    style: OutlinedButton.styleFrom(
                        ...
                        textStyle: Theme.of(context)
                            ...
                            ?.copyWith(fontWeight: FontWeight.w600)),
                    child:
                        Text(CourseMixin.enrollButtonText(course, user)).tr(),
                    onPressed: () =>
                        handleOpenCourse(context, user: user, course: course),
                  ),
                ],
              ),
            ),
