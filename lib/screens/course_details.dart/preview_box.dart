...
import 'package:talimger_mobile/utils/cache_image_filter.dart';
...
class PreviewBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool hasVideoPreview =
        course.videoUrl != null && course.videoUrl!.isNotEmpty ? true : false;
    return Stack(
      ...
      children: [
        InkWell(
          onTap: () {
            if (hasVideoPreview) {
              NextScreen.iOS(
                  context, VideoPlayerScreen(videoUrl: course.videoUrl!));
            }
          },
          child: Container(
            height: 200,
